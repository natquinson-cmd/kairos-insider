---
title: "Qu'est-ce qu'un 13F ? Le guide complet pour suivre les hedge funds américains en 2026"
...
1. [Définition du 13F](#definition)
2. [Qui est obligé de le déposer ?](#qui)
3. [Que contient précisément un 13F ?](#contenu)
4. [Les 3 limites essentielles à connaître](#limites)
5. [Comment lire un 13F comme un pro](#lecture)
6. [Les 5 investisseurs dont le 13F vaut le plus](#top5)
7. [Comment exploiter un 13F quand on est retail](#retail)
8. [FAQ](#faq)

---

## <a id="definition"></a>1. Définition du 13F
...
Chaque trimestre, les fonds concernés listent **toutes leurs positions longues** sur des actions américaines (NYSE, NASDAQ). Ces données sont **publiques**, gratuites, et consultables sur [SEC EDGAR](https://www.sec.gov/edgar/searchedgar/companysearch).
...
## <a id="qui"></a>2. Qui est obligé de déposer un 13F ?

Tous les **"institutional investment managers"** qui remplissent deux conditions :

1. **Juridiction US** (ou faire du business aux US)
2. Gérer **plus de 100 millions de dollars** en actifs éligibles (équités US cotées)
...
## <a id="contenu"></a>3. Que contient précisément un 13F ?
...
## <a id="limites"></a>4. Les 3 limites essentielles à connaître
...
## <a id="lecture"></a>5. Comment lire un 13F comme un pro
...
Une position de $50 M dans un fonds de $200 M (25% du portif) est une **conviction majeure**.
La même position de $50 M dans un fonds de $100 B (0.05%) est **juste du bruit**.

Toujours normaliser par l'AUM.

---

## <a id="top5"></a>6. Les 5 investisseurs dont le 13F vaut le plus
...
## <a id="retail"></a>7. Comment exploiter un 13F quand on est retail

### Option 1 · Consulter gratuitement sur SEC EDGAR

[SEC EDGAR full-text search](https://efts.sec.gov/LATEST/search-index?q=&forms=13F-HR) permet de rechercher par nom de fonds. Limite : interface austère, pas de comparaison inter-trimestre, pas de cross-holdings.
...
1. 45-135 jours de lag
2. Long only (pas de short visible)
3. Certaines positions peuvent être **confidentielles** pour raisons de compétition (une demande spéciale à la SEC) — rare, mais Berkshire l'a fait par le passé.
...
1. **Apprendre** comment les pros pensent (concentration, positions, horizons)
2. **Détecter les consensus** (plusieurs fonds top-tier sur le même ticker)
3. **Ne pas cloner aveuglément** — utiliser comme une source d'idées, pas comme des signaux d'achat immédiats
4. **Compléter avec 13D et Form 4** pour la rapidité

---

## 📈 Vous voulez tout ça prêt à consommer en français ?

**[Kairos Insider](https://kairosinsider.fr/)** agrège automatiquement les 13F des **200 plus gros hedge funds US** chaque trimestre. Pour chaque action, vous voyez :
...
**[Essayez gratuitement →](https://kairosinsider.fr/)**

---

## 📚 Articles connexes

- [Comment suivre Warren Buffett en temps réel](./02-suivre-warren-buffett.md)
- [Qui sont Elliott, Ackman, Icahn : comprendre les activists (13D)](./04-activists-elliott-ackman-icahn.md)
- [Smart money vs retail : qui gagne vraiment ?](./05-smart-money-vs-retail.md)
