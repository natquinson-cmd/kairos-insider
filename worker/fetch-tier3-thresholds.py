...
COUNTRY_CONFIG = {
    ...
    'ES': {
        ...
        'queries': [
            ...
            'CNMV+%22comunicacion%22+capital',
            '%22participacion+significativa%22+CNMV',
            'Spain+%22major+shareholding%22+CNMV',
        ...
        'keywords': r'(participaci[o]?n|significativ|umbral|stake|shareholding|CNMV|major\s+holding)',
        'list_keywords': ['ibex', 'bolsa madrid', 's\\.a', 'sa ', 'mercado continuo'],
    },
    'SE': {
        'name': 'Suede',
