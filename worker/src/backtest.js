...
const FILER_ALIASES = {
  ...
  'TCI FUND': ['TCI FUND', 'CHILDREN\'S INVESTMENT', 'CHRISTOPHER HOHN', 'TCI FUND MANAGEMENT'],
  // EU-based hedge funds + activists ajoutes (filent 13F)
  'CEVIAN': ['CEVIAN', 'CEVIAN CAPITAL', 'CHRISTER GARDELL'],
  'MARSHALL WACE': ['MARSHALL WACE', 'PAUL MARSHALL'],
  'LANSDOWNE': ['LANSDOWNE', 'LANSDOWNE PARTNERS'],
  'EGERTON': ['EGERTON', 'EGERTON CAPITAL', 'JOHN ARMITAGE'],
  'BREVAN HOWARD': ['BREVAN HOWARD', 'ALAN HOWARD'],
  'PELHAM': ['PELHAM CAPITAL', 'PELHAM'],
  'SCULPTOR': ['SCULPTOR', 'OCH-ZIFF', 'OCH ZIFF'],
  'AKO': ['AKO CAPITAL', 'AKO LLP', 'NICOLAI TANGEN'],
  'JANUS HENDERSON': ['JANUS HENDERSON', 'JANUS', 'HENDERSON GROUP'],
  // UK + EU Asset Managers (gestionnaires Investment Trusts UK + grandes maisons FR/CH)
  'BAILLIE GIFFORD': ['BAILLIE GIFFORD', 'BAILLIE'],
  'SCHRODERS': ['SCHRODERS', 'SCHRODER'],
  'ROYAL LONDON': ['ROYAL LONDON', 'ROYAL LONDON ASSET'],
  'LIONTRUST': ['LIONTRUST', 'LIONTRUST INVESTMENT'],
  'ABRDN': ['ABRDN', 'STANDARD LIFE ABERDEEN', 'ABERDEEN STANDARD'],
  'CARMIGNAC': ['CARMIGNAC', 'CARMIGNAC GESTION', 'EDOUARD CARMIGNAC'],
  'AMUNDI': ['AMUNDI'],
  'COMGEST': ['COMGEST', 'COMGEST GLOBAL'],
  'BNP PARIBAS AM': ['BNP PARIBAS ASSET', 'BNP PARIBAS INVESTMENT'],
  'ODDO BHF': ['ODDO BHF', 'ODDO'],
  'PICTET': ['PICTET ASSET', 'PICTET'],
