---
title: "Fonds activistes : qui sont Elliott, Ackman, Icahn et comment les suivre en 2026"
...
1. [Qu'est-ce qu'un fonds activiste ?](#definition)
2. [13D vs 13G : la différence cruciale](#13d)
3. [Les 5 plus gros activistes au monde](#top5)
4. [Les 4 stratégies activistes classiques](#strategies)
5. [Études de cas : 5 coups historiques](#cases)
6. [Comment détecter un 13D en temps réel](#detecter)
7. [Les erreurs classiques du retail](#erreurs)
8. [FAQ](#faq)

---

## <a id="definition"></a>1. Qu'est-ce qu'un fonds activiste ?
...
## <a id="13d"></a>2. 13D vs 13G : la différence cruciale
...
## <a id="top5"></a>3. Les 5 plus gros activistes au monde en 2026
...
## <a id="strategies"></a>4. Les 4 stratégies activistes classiques
...
## <a id="cases"></a>5. Études de cas : 5 coups historiques
...
## <a id="detecter"></a>6. Comment détecter un 13D en temps réel

### Option 1 : SEC EDGAR directement

[SEC EDGAR full-text search](https://efts.sec.gov/LATEST/search-index?q=&forms=SC+13D) permet de filtrer par formulaire SC 13D.
...
## <a id="erreurs"></a>7. Les erreurs classiques du retail
...
Pour l'instant, **non** — couverture US SEC uniquement. La France publie les **déclarations de franchissement de seuil AMF** (équivalent 13D), accessibles sur [amf-france.org](https://www.amf-france.org). Nous travaillons à intégrer ce flux pour fin 2026.
