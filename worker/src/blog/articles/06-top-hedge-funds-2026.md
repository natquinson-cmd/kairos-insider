---
title: "Les 5 meilleurs hedge funds à suivre en 2026 (track record + thèses actives)"
...
1. [Comment on classe un "meilleur" hedge fund ?](#critere)
2. [#1 Berkshire Hathaway — Warren Buffett](#berkshire)
3. [#2 Pershing Square — Bill Ackman](#pershing)
4. [#3 Baupost Group — Seth Klarman](#baupost)
5. [#4 Renaissance Technologies — James Simons](#renaissance)
6. [#5 Appaloosa Management — David Tepper](#appaloosa)
7. [3 fonds à éviter en 2026](#eviter)
8. [Comment suivre ces fonds en temps réel](#suivre)
9. [FAQ](#faq)

---

## <a id="critere"></a>1. Comment on classe un "meilleur" hedge fund ?
...
## <a id="berkshire"></a>2. 🥇 Berkshire Hathaway — Warren Buffett
...
- **13F-HR** trimestriel : SEC EDGAR CIK `0001067983`, publié mi-février / mi-mai / mi-août / mi-novembre
- **Form 4** : transactions Berkshire > 10 % (délai 2 jours)
- **Lettre annuelle** (février) : positions japonaises + vision macro
- **Sur Kairos** : onglet Hedge Funds → Berkshire Hathaway

> 📖 Lire aussi : [Comment suivre Warren Buffett en temps réel](./comment-suivre-warren-buffett.md)

---

## <a id="pershing"></a>3. 🥈 Pershing Square Capital — Bill Ackman
...
- **13F** : CIK `0001336528`
- **Twitter/X @BillAckman** : 1,5 M followers, thèses souvent révélées **avant** 13D/F
- **Lettre annuelle Pershing Square Holdings** (PSH) cotée à Amsterdam : très transparente

---

## <a id="baupost"></a>4. 🥉 Baupost Group — Seth Klarman
...
- **13F** : CIK `0001061768` (dépôt systématiquement le **dernier jour possible**, 45 jours pleins après Q)
- **Livre culte** : *Margin of Safety* (1991) — épuisé, se revend 2 500 $ sur eBay
...
## <a id="renaissance"></a>5. Renaissance Technologies — James Simons (†2024)
...
- **13F** : CIK `0001037389`
- **Utilité pour le retail** : détecter les **accumulations quantitatives** (quand RenTech est dans un ticker, c'est souvent le signe d'une anomalie statistique exploitable)
...
## <a id="appaloosa"></a>6. Appaloosa Management — David Tepper
...
- **13F** : CIK `0001006438`
- **CNBC Squawk Box** : Tepper y apparaît de temps en temps, ses déclarations bougent le marché
- **Sur Kairos** : onglet Hedge Funds → Appaloosa

---

## <a id="eviter"></a>7. Les 3 fonds "stars éphémères" à ÉVITER en 2026
...
## <a id="suivre"></a>8. Comment suivre ces fonds en temps réel

### Option 1 : SEC EDGAR (manuel, gratuit)

- Cherchez chaque CIK (listés ci-dessus) dans [EDGAR search](https://efts.sec.gov/LATEST/search-index?q=&forms=13F-HR)
...
1. 📊 **Combinez plusieurs fonds** — Berkshire (value) + Pershing (concentré activism) + Baupost (contrarian) couvrent 3 styles complémentaires
2. 🎯 **Regardez les nouvelles positions** — bien plus significatives que les positions établies
3. 🔔 **Suivez les Form 4 et 13D** pour avoir les mouvements en quasi-temps-réel (2-10 jours vs 45 jours pour 13F)
...
- [Qu'est-ce qu'un 13F ?](./quest-ce-quun-13F.md)
