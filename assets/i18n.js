...
(function(global) {
  ...
  const DICT = {
    fr: {
      ...
      'hero.subtitle_html': 'Suivez chaque jour les mouvements des <strong>500+ plus grands hedge funds</strong>, des <strong>dirigeants d\'entreprise</strong>, des <strong>fonds offensifs (🇺🇸 🇫🇷 🇩🇪 🇬🇧)</strong> et des <strong>ETF thématiques</strong>. Un Kairos Score composite 0-100 synthétise 8 dimensions du smart money pour chaque action.',
    ...
    en: {
      ...
      'hero.subtitle_html': 'Track every day the moves of the <strong>500+ largest hedge funds</strong>, <strong>company executives</strong>, <strong>activist funds (🇺🇸 🇫🇷 🇩🇪 🇬🇧)</strong> and <strong>thematic ETFs</strong>. A composite Kairos Score 0-100 synthesizes 8 smart-money dimensions for every stock.',
