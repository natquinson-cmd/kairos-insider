...
(function(global) {
  ...
  const DICT = {
    fr: {
      ...
      'dash.section.hotStocks.desc': 'Les actions dont l\'interet retail explose en ce moment. Base sur les donnees Google Trends — l\'attention retail precede souvent les mouvements de prix, surtout sur les small caps. Mis a jour quotidiennement.',
      ...
      'dash.section.screener.desc': 'Filtres combinables sur l\'historique complet des transactions insiders (jusqu\'a 5 ans). Filtre par role, montant, periode, ticker, source — exporte les resultats en CSV.',
      'dash.section.topInsiders.title': '🏆 Top Insiders',
      'dash.section.topInsiders.desc': 'Classement des insiders les plus actifs sur la periode. Repere les executives dont les trades sont les plus massifs et les plus frequents — une premiere approximation du "qui vaut la peine d\'etre suivi".',
      ...
      'dash.section.etf.desc': 'Positions en temps reel des ETF qui repliquent les strategies des grands investisseurs, politiciens, sentiment retail et thematiques.',
      ...
      'dash.section.shorts.desc': 'Actions les plus shortees du marche US — detectez les potentiels short squeezes.',
      ...
      'dash.section.watchlist.desc': 'Suivez vos actions preferees et recevez chaque matin a 8h un digest email des evenements smart-money detectes : nouveaux clusters insiders, entrees/sorties d\'ETF, variations du Kairos Score.',
    ...
    en: {
      ...
      'dash.home.stat_clusters_title': 'Clusters detected',
      ...
      'dash.home.watchlist_desc': 'Track your favorite stocks and receive a <strong>daily email digest</strong> at 8am with detected smart-money events: insider clusters, ETF rotations, Kairos Score changes.',
      ...
      'dash.section.watchlist.desc': 'Track your favorite stocks and receive a daily email digest at 8am with detected smart-money events: new insider clusters, ETF entries/exits, Kairos Score changes.',
