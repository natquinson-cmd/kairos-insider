...
(function(global) {
  ...
  const DICT = {
    fr: {
      ...
      'pricing.elite.f_api': '<strong>API REST</strong> pour intégrer la data dans vos outils',
    ...
    en: {
      ...
      'pricing.elite.f_api': '<strong>REST API</strong> to integrate data into your tools',
