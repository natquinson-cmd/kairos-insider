...
(function(global) {
  ...
  const DICT = {
    fr: {
      ...
      'analysis.alert_cta_title': 'Reçois une alerte dès qu\'un nouveau 13D ou cluster insider est détecté sur ${ticker}',
      'analysis.alert_cta_subtitle': 'Latence < 8 min après filing SEC · Telegram + email · Bêta gratuite, pas de carte bancaire',
      'analysis.alert_cta_btn': 'Activer (gratuit)',
    ...
    en: {
      ...
      'analysis.alert_cta_title': 'Get an alert as soon as a new 13D or insider cluster is detected on ${ticker}',
      'analysis.alert_cta_subtitle': 'Latency < 8 min after SEC filing · Telegram + email · Free beta, no credit card',
      'analysis.alert_cta_btn': 'Enable (free)',
