...
(function(global) {
  ...
  const DICT = {
    fr: {
      ...
      'hero.subtitle_html': 'Suivez chaque jour les mouvements des <strong>500+ plus grands hedge funds</strong>, des <strong>dirigeants d\'entreprise</strong>, des <strong>politiciens US</strong> et des <strong>ETF thématiques</strong>. Un Kairos Score composite 0-100 synthétise 8 dimensions du smart money pour chaque action.',
      ...
      'faq.a_try': 'Oui. Créez un compte gratuit en 30 secondes — sans carte bancaire. Vous aurez accès à : <strong>3 analyses complètes par jour</strong> (Kairos Score + radar 8 axes), Fear & Greed, Short Interest, Hot Stocks Google Trends et un aperçu smart money sur 1 000+ tickers. Si vous aimez, passez Pro à 19€/mois pour débloquer les analyses illimitées, les hedge funds, les fonds offensifs et la watchlist.',
    ...
    en: {
      ...
      'hero.subtitle_html': 'Track every day the moves of the <strong>500+ largest hedge funds</strong>, <strong>company executives</strong>, <strong>US politicians</strong> and <strong>thematic ETFs</strong>. A composite Kairos Score 0-100 synthesizes 8 smart-money dimensions for every stock.',
      ...
      'faq.a_try': 'Yes. Create a free account in 30 seconds — no credit card required. You\'ll get: <strong>3 full analyses per day</strong> (Kairos Score + 8-axis radar), Fear & Greed, Short Interest, Hot Stocks Google Trends and a smart money preview on 1,000+ tickers. If you like it, upgrade to Pro at €19/month to unlock unlimited analyses, hedge funds, activist investors and watchlist.',
